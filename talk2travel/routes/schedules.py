...
def get_recommendations():
    ...
    # 2) 숙소 검색 → 가격순 상위 3건 → 사용자용 최소 정보로 변환
    hotel_ids    = get_hotel_ids(destination, max_results=10)
